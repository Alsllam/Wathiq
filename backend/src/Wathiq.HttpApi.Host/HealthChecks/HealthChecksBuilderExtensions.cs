...
{
    public static void AddWathiqHealthChecks(this IServiceCollection services)
    {
        ...
        {
            settings.AddHealthCheckEndpoint("Wathiq Health Status", configuration["App:HealthUiCheckUrl"] ?? healthCheckUrl);
        });
