...
public class WathiqDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        WathiqGlobalFeatureConfigurator.Configure();
        WathiqModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<WathiqDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<WathiqResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Wathiq");

            options.DefaultResourceType = typeof(WathiqResource);
        ...
        {
            options.MapCodeNamespace("Wathiq", typeof(WathiqResource));
        });
    }
}
