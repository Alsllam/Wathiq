...
| 0.1.13 | 2026-09-07 | Abdulsalam | Migrations log row 14: `GuideFeedback` table (5.6), marked *Implemented* |
...
### `guides.GuideFeedback` (E-GuideFeedback) — *Implemented (5.6)*
...
| 14 | 2026-09-07 | Guides | `20260907051814_AddGuideFeedback` — table `GuideFeedback` (FK→GuideVersion Cascade; IX `GuideVersionId`; `Kind` tinyint; `UserId` nullable = anonymous reader; no cross-schema FK to users per DB2) | 5.6 |
